...
number = '6282132805286@s.whatsapp.net'
...
sendButImage(anu.jid, teks, `™Recode By DEFFBOTz`, img,but = [{buttonId:`hallo`, 
...
img = await getBuffer(ppUrl)
teks = `Bye Bye @${num.split('@')[0]}\nBeban Keluar Dari Grup: ${mdata.subject}\nBye Bye👋`
sendButImage(anu.jid, teks, `®Recode : By DEFFBOTz`, img,but= [{buttonId: `byebye`, buttonText: {displayText: `SELAMAT TINGGAL!!!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, number]}, thumbnail: Buffer.alloc(0)})
}
